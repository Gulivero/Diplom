...
public class DataAdapterComplete extends RecyclerView.Adapter<DataAdapterComplete.ViewHolder> {
    ...
    public DataAdapterComplete(Context context, List<Quest> questsList, List<Image> imagesList) {
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        DataAdapterComplete.clickListener = clickListener;
    }
    ...
    @Override
    public DataAdapterComplete.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
